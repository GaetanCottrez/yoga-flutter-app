        ...
        children: [
          ...
          Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal: appPadding, vertical: 5),
              child:
                  Center(child: Image.network(_course.imageUrl, width: 250))),
          Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal: appPadding, vertical: 10),
              child: Text(
                _course.description,
                style: TextStyle(
                  fontSize: 14,
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: GestureDetector(
              onTap: () {
                printInternal('DetailPose ' + pose.english_name);
                /* Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => DetailPose(pose: pose))); */
              },
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
